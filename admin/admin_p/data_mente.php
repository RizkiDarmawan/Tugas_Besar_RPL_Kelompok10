...
?>			<div id="breadcrumb">
			...
			<ul class="tab-bar grey-tab" id="tabbar">
				...
				<li>
					<a href="#mente" onclick="data_mentor.refreshtable('mente')" data-toggle="tab">
						<span class="block text-center">
				...
				<li>
					<a href="#rekap_mente" onclick="data_master.generatefakultas()" data-toggle="tab">
						<span class="block text-center">
                            ...
                            <div class="tab-pane fade in active fadeInDown animation-delay1" id="overview">
								<div class="panel panel-default table-responsive fadeInUp animation-delay1">
									<div class="panel-heading">
									    <span class="pull-left"><i class="fa fa-bar-chart-o fa-lg"></i></span> &nbsp; Data Mente
									    <ul class="tool-bar">
									   	    <li><a href="#" onclick="data_mentor.refreshtable('mente');" class="refresh-widget" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Refresh"><i class="fa fa-refresh"></i></a></li>
										</ul>
										<a href="#" style="display:none;" id="mente-refresh" class="refresh-widget" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Refresh"><i class="fa fa-refresh"></i></a>
									</div>
									<div class="panel-body">
									    <div class="row">
                                            <form id="mente-searchform" method="post" onsubmit="return data_mentor.searching('mente')">
											<div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                <input type="hidden" name="table" value="mente" />
											...
											<div class="col-md-2">
                                                <select class="form-control input-sm" name="liqo"><option value="">- Liqo -</option>
                                                          <option value="y">pernah</option>
                                                          <option value="t">belum pernah</option>
                                                </select>
                                            </div>
											<div class="col-md-2">
                                                <select class="form-control input-sm" name="rohis"><option value="">- Rohis -</option>
                                                          <option value="y">alumni</option>
                                                          <option value="t">bukan alumni</option>
                                                </select>
                                            </div>
											<div class="col-md-4">
												 <div class="input-group" style="z-index:0; margin-bottom:10px;" id="mente-search">
									    ...
									    <div id="mente-tableinfo"></div>
										<div id="mente-table"></div>
									</div>
...
<!-- DETAIL MENTE ========================================================================================================= DETAIL MENTE -->						
							<div class="tab-pane fade" id="mente">
									<div class="col-md-6">
											...
											<div class="list-group">
												<a href="#" class="list-group-item">
													<div class="list-group-item-text clearfix">
														<div class="pull-left m-left-sm m-top-sm" id="prestasi">
															<span class="badge badge-warning">prestasi</span>
                                                        </div>
													</div>
												</a>
											</div><!-- /list-group -->	
...
<!-- DATA MENTE ============================================================================================================= DATA MENTE -->						
                            <div class="tab-pane fade fadeInDown animation-delay1" id="rekap_mente">
								<div class="panel panel-default table-responsive fadeInUp animation-delay1">
									<div class="panel-heading">
									    <span class="pull-left"><i class="fa fa-bar-chart-o fa-lg"></i></span> &nbsp; Data Mente
									    <ul class="tool-bar">
									...
									<div class="panel-body">
									    <div class="row">
                                            <form id="mente-searchform" target="_blank" method="get" action="../../lib/pdfClass.php">
											<div class="col-md-2">
                                                <select class="form-control input-sm" name="gender"><option value="">- Gender -</option>
                                                          <option value="L">ikhwan</option>
                                                          <option value="P">akhwat</option>
											...
											<div class="col-md-12">
												 <div class="input-group text-center" style="z-index:0; margin-bottom:10px;">
							            			  <div class="input-group-btn"><button type="submit" name="mente" class="btn btn-lg btn-success" tabindex="-1">Rekap To PDF</button></div>
							        			 </div>
											</div>
                                            </form>
										</div>
