...
<html lang="en">
  ...
  <body class="overflow-hidden" onload="portal.initialize(); app.initialize();">
	<!-- Overlay Div -->
	...
	<div id="wrapper" class="preload">
		<div id="top-nav" class="fixed skin-6">
			<a href="#" class="brand">
				<span>Portal</span>
				<span class="text-toggle"> Dosen</span>
			</a><!-- /brand -->					
			...
			<ul class="nav-notification clearfix">
				...
				<li class="profile dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<strong><?php echo$_SESSION['lmai_nama_dosen']; ?></strong>
...
<!----------------------------- -------------------------------------------------------------------------------------------------------------------------------->
	    ...
	    <?php
            $lmai_id_dosen = $_SESSION['lmai_id_dosen'];
            $lmai_nama_dosen = $_SESSION['lmai_nama_dosen'];
